...
def test_create_agent_returns_agent():
    ...
    mock_provider_factory.create_provider.return_value = MagicMock()
    ...
    config = AgentConfig(
        ...
        tools=["create_post", "comment_tool"],
...
def test_create_agent_creates_client_with_api_key():
    ...
    mock_client_cls.assert_called_once_with(api_key="cv_live_special_key")
